...
export const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'upload.guide.intro':
      'El CSV debe incluir esta cabecera exacta (14 columnas, en este orden). Los nombres de columna no distinguen mayúsculas ni minúsculas. Si algún campo contiene comas, escríbelo entre comillas dobles.',
    ...
    'upload.guide.column.ean': 'Código de barras: 8 o 13 dígitos.',
    ...
    'upload.guide.column.sku': 'SKU propio de tu tienda.',
    'upload.guide.column.price': 'Precio de venta. Número no negativo con máximo 2 decimales (no se redondea: con más de 2 decimales la fila se rechaza). Admite símbolos de moneda y coma decimal (ej. 19,99 €). Vacío = conservar el precio actual de la tienda.',
    ...
    'upload.guide.column.quantity': 'Stock disponible. Entero no negativo (no se trunca: si tiene decimales la fila se rechaza). Vacío = no modificar el stock existente en la tienda.',
    'upload.guide.column.brand': 'Marca del producto (máximo 64 caracteres, límite de PrestaShop).',
    'upload.guide.column.manufacturer': 'Fabricante (máximo 64 caracteres, límite de PrestaShop).',
    ...
    'upload.guide.column.description': 'Descripción larga.',
    ...
    'upload.invalidRowsWarning': '— {count} fila(s) rechazada(s):',
  ...
  en: {
    ...
    'upload.guide.intro':
      'The CSV must include this exact header (14 columns, in this order). Column names are case-insensitive. If any field contains a comma, wrap it in double quotes.',
    ...
    'upload.guide.column.ean': 'Barcode: 8 or 13 digits.',
    ...
    'upload.guide.column.sku': 'Store-specific SKU.',
    'upload.guide.column.price': 'Selling price. Non-negative number with at most 2 decimal places (not rounded: more than 2 decimals reject the row). Currency symbols and decimal commas allowed (e.g. $19.99). Leave empty to keep the current store price.',
    ...
    'upload.guide.column.quantity': 'Available stock. Non-negative integer (not truncated: decimals reject the row). Leave empty to keep the existing store stock.',
    'upload.guide.column.brand': 'Product brand (max 64 characters, PrestaShop limit).',
    'upload.guide.column.manufacturer': 'Manufacturer (max 64 characters, PrestaShop limit).',
    ...
    'upload.guide.column.description': 'Long description.',
    ...
    'upload.invalidRowsWarning': '— {count} row(s) rejected:',
