...
export const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'upload.guide.intro':
      'El CSV debe incluir esta cabecera exacta (16 columnas, en este orden). Los nombres de columna no distinguen mayúsculas ni minúsculas.',
    ...
    'upload.guide.column.ean': 'Código de barras: 8 o 13 dígitos. Se usa para detectar duplicados y emparejar imágenes.',
    'upload.guide.column.reference': 'Referencia interna del producto. También se usa para duplicados e imágenes.',
    'upload.guide.column.name': 'Nombre del producto.',
    'upload.guide.column.sku': 'SKU propio de tu tienda.',
    'upload.guide.column.price': 'Precio de venta. Número no negativo; admite símbolos de moneda y coma decimal (ej. 19,99 €).',
    'upload.guide.column.wholesale_price': 'Precio de coste o de proveedor. Mismo formato que price.',
    'upload.guide.column.quantity': 'Stock disponible. Entero no negativo.',
    'upload.guide.column.stock': 'Sinónimo de quantity: rellena una de las dos.',
    ...
    'upload.guide.column.tax': 'Impuesto en porcentaje: 21 = 21 %. Admite de 0 a 100.',
    'upload.guide.column.weight': 'Peso en kg. Número no negativo (ej. 2.5 o 1,2).',
    'upload.guide.column.description_short': 'Descripción corta del producto.',
    'upload.guide.column.description': 'Descripción larga. Si contiene comas, escríbela entre comillas.',
  ...
  en: {
    ...
    'upload.guide.intro':
      'The CSV must include this exact header (16 columns, in this order). Column names are case-insensitive.',
    ...
    'upload.guide.column.ean': 'Barcode: 8 or 13 digits. Used to detect duplicates and match images.',
    'upload.guide.column.reference': 'Internal product reference. Also used for duplicates and images.',
    'upload.guide.column.name': 'Product name.',
    'upload.guide.column.sku': 'Store-specific SKU.',
    'upload.guide.column.price': 'Selling price. Non-negative number; currency symbols and decimal commas allowed (e.g. $19.99).',
    'upload.guide.column.wholesale_price': 'Cost or supplier price. Same format as price.',
    'upload.guide.column.quantity': 'Available stock. Non-negative integer.',
    'upload.guide.column.stock': 'Synonym for quantity: fill in either one.',
    ...
    'upload.guide.column.tax': 'Tax rate as a percentage: 21 = 21%. Accepts 0 to 100.',
    'upload.guide.column.weight': 'Weight in kg. Non-negative number (e.g. 2.5 or 1.2).',
    'upload.guide.column.description_short': 'Short product description.',
    'upload.guide.column.description': 'Long description. Wrap in quotes if it contains commas.',
