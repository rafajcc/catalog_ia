...
export const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'upload.prestashopTitle': 'Otra fuente de datos: PrestaShop',
    'upload.prestashopIntro': 'Descarga productos directamente desde tu tienda PrestaShop (Webservice) en lugar de subir un CSV.',
    'upload.prestashopEansLabel': 'Códigos EAN (uno por línea o separados por comas)',
    'upload.prestashopEansPlaceholder': '8412345678901, 8423456789012',
    'upload.prestashopReferencesLabel': 'Referencias (una por línea o separadas por comas)',
    ...
    'upload.prestashopNoCriteria': 'Introduce al menos un EAN o una referencia',
    ...
    'upload.prestashopConflictCsv': 'Importar desde PrestaShop descartará los archivos CSV subidos actualmente. ¿Continuar?',
    'upload.prestashopConflictPs': 'Subir un CSV reemplazará los datos importados desde PrestaShop.',
    ...
    'validation.uploadButton': 'Subir cambios',
    'validation.uploaded': 'Cambios subidos a PrestaShop',
    'validation.productsUpdated': '{count} productos actualizados',
    'validation.combinationsUpdated': '{count} combinaciones actualizadas',
    'validation.stockUpdated': '{count} stocks actualizados',
    'validation.failedOperations': '{count} operaciones fallidas',
    'validation.consistencyIssues': '{count} inconsistencias',
    'validation.notFound': '{count} EAN sin coincidencia',
    'validation.consistencySkipped': 'Comprobación de PrestaShop omitida: configura PrestaShop para habilitar la subida',
    'validation.uploadDisabled': 'Ejecuta "Validar productos" para habilitar la subida.',
    'validation.editHint': 'Edita las celdas para corregir inconsistencias y pulsa "Subir cambios".',
    'validation.conflictHint': 'Valor inconsistente con otras variantes del mismo producto.',
    'validation.price': 'Precio',
    'validation.wholesalePrice': 'Precio coste',
    'validation.quantity': 'Stock',
    'validation.brand': 'Marca',
    'validation.category': 'Categoría',
    'validation.tax': 'Impuesto',
    'validation.descriptionShort': 'Descripción corta',
    'validation.description': 'Descripción',
  ...
  en: {
    ...
    'upload.prestashopTitle': 'Alternative data source: PrestaShop',
    'upload.prestashopIntro': 'Fetch products directly from your PrestaShop store (Webservice) instead of uploading a CSV.',
    'upload.prestashopEansLabel': 'EAN codes (one per line or comma-separated)',
    'upload.prestashopEansPlaceholder': '8412345678901, 8423456789012',
    'upload.prestashopReferencesLabel': 'References (one per line or comma-separated)',
    'upload.prestashopReferencesPlaceholder': 'REF-001, REF-002',
    ...
    'upload.prestashopNoCriteria': 'Enter at least one EAN or one reference',
    ...
    'upload.prestashopConflictCsv': 'Fetching from PrestaShop will discard the currently uploaded CSVs. Continue?',
    'upload.prestashopConflictPs': 'Uploading a CSV will replace the data imported from PrestaShop.',
    ...
    'validation.uploadButton': 'Upload changes',
    'validation.uploaded': 'Changes uploaded to PrestaShop',
    'validation.productsUpdated': '{count} products updated',
    'validation.combinationsUpdated': '{count} combinations updated',
    'validation.stockUpdated': '{count} stock updated',
    'validation.failedOperations': '{count} operations failed',
    'validation.consistencyIssues': '{count} inconsistencies',
    'validation.notFound': '{count} EANs not found',
    'validation.consistencySkipped': 'PrestaShop consistency check skipped: configure PrestaShop to enable upload',
    'validation.uploadDisabled': 'Run "Validate products" first to enable upload.',
    'validation.editHint': 'Edit cells to fix inconsistencies, then press "Upload changes".',
    'validation.conflictHint': 'Value inconsistent with other variants of the same product.',
    'validation.price': 'Price',
    'validation.wholesalePrice': 'Wholesale price',
    'validation.quantity': 'Quantity',
    'validation.brand': 'Brand',
    'validation.category': 'Category',
    'validation.tax': 'Tax',
    'validation.descriptionShort': 'Short description',
