...
export const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'upload.prestashopIntro': 'Descarga productos directamente desde tu tienda PrestaShop (Webservice) en lugar de subir un CSV. Sin EAN ni referencia se importan los primeros productos de la tienda.',
  ...
  en: {
    ...
    'upload.prestashopIntro': 'Fetch products directly from your PrestaShop store (Webservice) instead of uploading a CSV. Without EANs or references, the first products of the store are imported.',
