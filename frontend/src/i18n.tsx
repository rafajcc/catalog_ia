...
export const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'upload.guide.column.reference': 'Referencia interna del producto.',
    'upload.guide.column.name': 'Nombre del producto.',
    'upload.guide.column.sku': 'SKU propio de tu tienda.',
    'upload.guide.column.price': 'Precio de venta. Número no negativo; admite símbolos de moneda y coma decimal (ej. 19,99 €). Vacío = conservar el precio actual de la tienda.',
    'upload.guide.column.wholesale_price': 'Precio de coste o de proveedor. Mismo formato que price. Vacío = conservar el actual.',
    'upload.guide.column.quantity': 'Stock disponible. Entero no negativo. Vacío = no modificar el stock existente en la tienda.',
    'upload.guide.column.brand': 'Marca del producto.',
    'upload.guide.column.manufacturer': 'Fabricante.',
  ...
  en: {
    ...
    'upload.guide.column.reference': 'Internal product reference.',
    'upload.guide.column.name': 'Product name.',
    'upload.guide.column.sku': 'Store-specific SKU.',
    'upload.guide.column.price': 'Selling price. Non-negative number; currency symbols and decimal commas allowed (e.g. $19.99). Leave empty to keep the current store price.',
    'upload.guide.column.wholesale_price': 'Cost or supplier price. Same format as price. Leave empty to keep the current value.',
    'upload.guide.column.quantity': 'Available stock. Non-negative integer. Leave empty to keep the existing store stock.',
    'upload.guide.column.brand': 'Product brand.',
    'upload.guide.column.manufacturer': 'Manufacturer.',
